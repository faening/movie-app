...
/**
 * Esta classe é usada para animar a altura de um ViewPager2 com base na altura da página atual.
 * Fonte: https://github.com/android/views-widgets-samples/issues/184
 */
